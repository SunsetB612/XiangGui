...
public class AppProperties {
    private JwtProperties jwt;                    // JWT 配置
...
| 层级 | 职责 | 禁止事项 |
|------|------|---------|
| Controller | HTTP 请求处理、参数校验 | 禁止写业务逻辑 |
| Service | 业务逻辑、事务管理 | 禁止直接操作 SQL |
